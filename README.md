...
```bash
# 基本使用法（Gitワンライナー実行）
curl -sSL https://raw.githubusercontent.com/kuiswin/gcp-common-tools/main/pre_flight.sh | bash
```
...
```bash
# 基本使用法（Gitワンライナー実行）
curl -sSL https://raw.githubusercontent.com/kuiswin/gcp-common-tools/main/teardown.sh | bash
```
